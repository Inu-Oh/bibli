...
# alternative if using custom User model: from django.contrib.auth.models import User
...
class Book(models.Model):
    ...
    def display_genre(self):
        """Create a string for the Genre. This is needed to display genre in Admin."""
...
class BookInstance(models.Model):
    """Model representing a book copy (that can be borrowed from the library)."""
...
class Author(models.Model):
    ...
    def __str__(self):
        """String for representing the Author instance."""
